...
def createXemuConfig(iniConfig, system, rom, playersControllers):
    ...
    # Set Bios complex-4627 for Xbox or xbox-4627_debug.bin for chihiro
    if system.isOptSet("xemu_bios"):
        iniConfig.set("sys.files", "flashrom_path", system.config["xemu_bios"])
    else:
